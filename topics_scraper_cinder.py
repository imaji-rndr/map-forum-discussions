...
INTER_REQUEST_SLEEP = 20  # Time to sleep between individual requests
...
def fetch_topic_data(topic_id):
    ...
    try:
        ...
        # Sleep for a fixed interval to prevent hitting rate limits
